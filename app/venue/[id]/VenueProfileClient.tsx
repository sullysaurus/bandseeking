        ...
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2 space-y-8">
            ...
            <div className="bg-white border-4 border-black shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] p-6">
              ...
              {/* Interactive Map */}
              <div className="border-2 border-gray-300 rounded-lg overflow-hidden bg-gradient-to-br from-green-100 to-blue-100">
                <div className="relative h-[300px] flex items-center justify-center">
                  ...
                  <div className="relative z-10 text-center">
                    <div className="inline-flex items-center justify-center w-16 h-16 bg-red-500 border-4 border-black rounded-full shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] mb-4">
                      <MapPin className="w-8 h-8 text-white" />
                    </div>
                    <h4 className="text-xl font-black mb-2">{venue.name}</h4>
                    ...
                    <div className="flex flex-col sm:flex-row gap-2 justify-center">
                      ...
                      <a
                        href={`https://www.openstreetmap.org/search?query=${encodeURIComponent(venue.address + ', ' + venue.city + ', ' + venue.state)}`}
                        target="_blank"
                        rel="noopener noreferrer"
                        className="inline-flex items-center gap-2 px-4 py-2 bg-green-400 border-2 border-black font-black text-black hover:bg-green-500 transition-colors shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]"
                      >
                        <MapPin className="w-4 h-4" />
                        OPEN STREET MAP
                      </a>
                  ...
                  {/* Decorative elements */}
                  <div className="absolute top-4 left-4 w-3 h-3 bg-yellow-400 border border-black transform rotate-45"></div>
                  <div className="absolute top-8 right-6 w-2 h-2 bg-red-400 border border-black rounded-full"></div>
                  <div className="absolute bottom-6 left-8 w-4 h-4 bg-purple-400 border border-black"></div>
                  <div className="absolute bottom-4 right-4 w-3 h-3 bg-cyan-400 border border-black transform rotate-45"></div>
                </div>
              </div>
            </div>
          </div>

          ...
          {profiles.length > 0 && (
            <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
              {profiles.map((profile) => (
                <div key={profile.id} className="bg-white border-4 border-black p-6 shadow-[4px_4px_0px_0px_rgba(0,0,0,1)] hover:shadow-[8px_8px_0px_0px_rgba(0,0,0,1)] transition-all">
                  ...
                  <div className="flex items-start gap-4 mb-4">
                    ...
                    <div className="flex-shrink-0">
                      <span className={`px-2 py-1 border-2 border-black font-black text-xs ${
                        profile.is_published ? 'bg-lime-400' : 'bg-gray-400'
                      }`}>
                        {profile.is_published ? 'ACTIVE' : 'DRAFT'}
                      </span>
                    </div>
                  </div>
                  ...
                  <div className="flex gap-2 pt-2 border-t-2 border-black">
                    ...
                    {currentUser && (
                      <button
                        ...
                        className={`px-4 py-2 border-2 border-black font-black text-sm transition-colors ${
